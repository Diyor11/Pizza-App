...
export default function Header() {
  return (
      <div className="border-b-[1px] border-slate-200 py-2 bg-white">
        <div className='container mx-auto'>
            <div className="flex items-center justify-between">
              <ul className="flex items-center justify-between sm:justify-start w-full md:w-fit">
                ...
                <li className="mx-3 text-xs cursor-pointer hidden lg:block">Проверить адрес</li>
                <li className="mx-3 sm:text-xs text-[10px] cursor-pointer">
                  Среднее время доставки*: <b>00:24:19</b>
                </li>
              </ul>
              <ul className="items-center hidden sm:flex ">
                <li className="mx-3 text-xs cursor-pointer hidden lg:block">Время работы: с 11:00 до 23:00</li>
                <li className="mx-3 hidden item-center sm:flex">
                  <svg
                  width="18"
                  height="18"
                  viewBox="0 0 20 20"
                ...
                >
                  ...
                  <span className='text-xs ml-2 cursor-pointer'>Войти в аккаунт</span>
                </li>
              </ul>
            </div>
        </div>
